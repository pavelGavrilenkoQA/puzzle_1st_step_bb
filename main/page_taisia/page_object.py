...
if __name__ == "__main__":
    ...
    print(button_win())
    print(sugar_mesh_pack())
    print(button_back())
    print(button_settings())
    print(english_language())
    print(travelling_pack_color())
    print(travelling_pack_bw())
    print(button_start())
    print(text_setting())
    print(swipe_sound_on())
    print(swipe_sound_off())
    print(swipe_vibration_on())
    print(swipe_vibration_off())
    print(sound_vibration_on())
    print(english_flag_text())
    print(all_languages())
   ...
   # print(swipe_personalized_ads_on())
    ...
    print(swipe_analytics_personalized_ads_off())
    print(cloud_menu())
    print(link_in_setting())
    print(setting_and_coins())
    print(button_daily())
    print(daily_challenge())
    print(reward())
    print(bw_button_coming_soon())
    print(text_coming_soon())
    print(icon_shop())
    print(text_shop())
    print(first_product_buy())
    print(purchase_popap())
    print(locked_text_shop())
    print(product_list())
    print(product_3k_coins())
    print(sugar_mesh_bw())
    print(swipe_rotation_off())
    print(swipe_rotation_on())
    print(coins_3())
    print(coins_6())
    print(elements_16())
    print(button_yes())
    ...
    print(button_exit())
    print(button_no())
    print(completed_pack_with_1_art())
    print(completed_9_elements())
    print(elements_16_2())
    print(button_claim())
    print(completed_16_elements())
    print(next_element())
    print(elements_25())
    print(completed_25_level())
    print(elements_49())
    ...
    print(hourglass_2())
    print(hourglass_1())
    print(hourglass_main())
    print(text_exit())
    print(daily_puzzle_1())
    print(daily_puzzle_2())
    print(daily_puzzle_3())
    print(completed_0_daily_puzzle())
    print(completed_1_daily_puzzle())
    print(completed_2_daily_puzzle())
    print(completed_3_daily_puzzle())
    print(coins_91())
    print(android_card())
    print(text_oops())
    print(loading())
    print(price_4_dollars())
    print(price_0_dollars())
    print(hint_29())
    print(android_buy())
    print(android_choice())
    print(android_price_0())
    print(android_quantity_1())
    print(hint_28())
    print(hint_20())
    print(hint_8())
    print(hint_5())
